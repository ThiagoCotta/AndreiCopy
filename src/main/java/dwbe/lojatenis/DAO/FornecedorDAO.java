...
public class FornecedorDAO {
    ...
    public void cadastrarFornecedor(Fornecedor fornecedor) {
        ...
        String sql = "INSERT INTO Fornecedor(id, cnpj, numeroInscricao, nomeFantasia, dataDeAbertura, porte, atividadeEconomicaPrincipal, situcaoCadastral) VALUES(?,?,?,?,?,?,?,?)";
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            pstmt.setString(8, fornecedor.getSitucaoCadastral());
    ...
    public List<Fornecedor> listarFornecedores() {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                String situcaoCadastral = rs.getString("situcaoCadastral");

                Fornecedor fornecedor = new Fornecedor(nome, cpf, endereco, sexo, telefone, email, cnpj, numeroInscricao, nomeFantasia, dataDeAbertura, porte, atividadeEconomicaPrincipal, situcaoCadastral);
                fornecedor.setId(id);
    ...
    public Fornecedor buscarFornecedor(int id) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                fornecedor = new Fornecedor(nome, cpf, endereco, sexo, telefone, email, cnpj, numeroInscricao, nomeFantasia, dataDeAbertura, porte, atividadeEconomicaPrincipal, situcaoCadastral);
                fornecedor.setId(id);
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage());
    ...
    public void excluirFornecedor(int id) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            if (affectedRows == 0) {
                throw new SQLException("Deleting supplier failed, no rows affected.");
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage());
        }
